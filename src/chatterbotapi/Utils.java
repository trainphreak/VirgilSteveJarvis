...
class Utils
{
    ...
    public static String request(String url, Map<String, String> cookies, Map<String, String> parameters) throws Exception
    {
        ...
        if (cookies != null)
        {
            connection.getHeaderFields().entrySet().stream().filter(headerEntry -> headerEntry != null && headerEntry.getKey() != null && headerEntry.getKey().equalsIgnoreCase("Set-Cookie")).forEach(headerEntry -> {
